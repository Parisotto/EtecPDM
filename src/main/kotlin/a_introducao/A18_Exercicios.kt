...
// 1. Considere uma caixa d'água de 2 mil litros. Rômulo gostaria de encher a caixa d1água de 7 litros. Quantos balões cabem na caixa d'água sem que o volume seja excedido? Crie uma rotina usando while() ou do while() que retorne a resposta.
