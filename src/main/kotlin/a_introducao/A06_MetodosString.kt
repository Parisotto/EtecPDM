package a_introducao// Aula 6: Métodos e propriedades de String

fun main() {
    val str = "Programação Kotlin."
    var msg = ""

    msg = "Tamanho da string: ${str.length}"
    // propriedade length (comprimento, tamanho)

    msg = "Posição (index) 0 da string: ${str[0]}"
    ...
    // método de string que recupera do índice 2 até antes do 4
